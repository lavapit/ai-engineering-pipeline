...
class ColpaliRAG:
    ...
    def process_file(
        ...
        results = [
            ...
            for i, (colpali_emb, img_base64, text) in enumerate(
                zip(colpali_embeddings, image_base64, texts)
            )
        ]
    ...
    def flatten_and_zero_pad(self, tensor, desired_length):
    ...
    def search(
        ...
        if limit:
            ...
            print("No Limits set getting the enter Table")
            r = self.table.search()
